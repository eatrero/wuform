...
- (NSManagedObjectModel *)managedObjectModel
{
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Entry" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Entry.sqlite"];
  ...
  // uncomment to remove persistent store
  //[[NSFileManager defaultManager] removeItemAtURL:storeURL error:nil];
